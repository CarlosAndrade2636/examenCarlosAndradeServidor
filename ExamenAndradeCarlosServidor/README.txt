...
a persistence unit "ExamenAndradeCarlosServidorPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenAndradeCarlosServidor\pom.xml":
...
artifact ("ExamenAndradeCarlosServidor.war") is already built. You can build
