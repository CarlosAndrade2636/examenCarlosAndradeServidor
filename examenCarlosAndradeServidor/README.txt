...
a persistence unit "examenCarlosAndradeServidorPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "examenCarlosAndradeServidor\pom.xml":
...
artifact ("examenCarlosAndradeServidor.war") is already built. You can build
